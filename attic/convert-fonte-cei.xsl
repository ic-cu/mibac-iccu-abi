...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Foglio di stile per l'aggiunta della "fonte AICE" Presuppone che il 
		file sorgente sia già in formato 1.6. Non rimuove la fonte dalla url nei 
		contatti, perché è molto più facile farlo con un grep. -->
		...
		<xsl:element name="anagrafica">
			...
			<xsl:element name="fonte">
				<xsl:element name="descrizione">
					Anagrafe degli Istituti Culturali Ecclesiastici (AICE)
				</xsl:element>
