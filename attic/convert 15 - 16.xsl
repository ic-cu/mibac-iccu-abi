...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- I primi due dei prossimi template correggono il famoso errore "Istituzione". 
		Il successivo corregge i codici ISIL, ma solo se mancanti dell'IT- e non 
		lunghi 6. Non è un gran test. -->
