...
>
	...
	<xsl:template name="servizi">
		<xsl:element name="servizi">
			...
			<!--
				...
				alle sezioni speciali perché esse hanno un contenitore sia in input che in output, e la molteplicità va gestita opportunamente
			-->
	...
	<xsl:template name="sezioni-speciali">
		<xsl:if test="contains(SERVIZI/SERVIZIO, 'meroteca') or contains(SERVIZI/SERVIZIO, 'agazzi')">
			<sezioni-speciali>
