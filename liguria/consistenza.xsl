...
<!--
Se queste sono tutte biblioteche con totcons significativo, diamo per scontato
che abbiano volumi e opuscoli, ma evitiamo la quantificazione perché a questo
punto ancora non sappiamo come quantificare. Se più avanti si trovassero 
"Edizioni XX/XXI adulti", verrebbe creato un secondo "volumi e opuscoli" 
quantificato che, in import, sovrascriverebbe questo qui sotto.  
 -->		
...
(per "nome") il risultato della mappatura, se questa è possibile
 -->		
